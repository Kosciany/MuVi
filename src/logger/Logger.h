...
#define MUVI_AUDIO_CRITICAL(...)    ::MuVi::Logger::GetAudioWorkerLogger()->critcal(__VA_ARGS__)
...
#define MUVI_FFT_CRITICAL(...)      ::MuVi::Logger::GetFftWorkerLogger()->critcal(__VA_ARGS__)
...
#define MUVI_RENDERER_CRITICAL(...) ::MuVi::Logger::GetRendererWorkerLogger()->critcal(__VA_ARGS__)
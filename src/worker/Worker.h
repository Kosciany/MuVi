...
template <typename P, int BUF_ELEMS> class Producer {
    private:

    public:
        std::binary_semaphore m_Semaphore;
        boost::lockfree::spsc_queue<P, boost::lockfree::capacity<BUF_ELEMS>> m_Queue;
...
template <typename C, int BUF_ELEMS> class Consumer {
    private:
        std::thread m_Thread;
